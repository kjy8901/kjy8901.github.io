...
![Alt text](/assets/subnetmask/aclass.png){: width="350"}

2진수로 변환했을때 맨앞이 0인경우 (00000000 ~ 01111111 즉 0~127) A클래스가 사용하는 기본 서브넷 마스크는 255.0.0.0 이다

#### B class

![Alt text](/assets/subnetmask/bclass.png){: width="350"}
맨앞이 10일 경우

#### C class

![Alt text](/assets/subnetmask/cclass.png){: width="350"}

#### D class

![Alt text](/assets/subnetmask/dclass.png){: width="350"}

#### E class

![Alt text](/assets/subnetmask/eclass.png){: width="350"}
