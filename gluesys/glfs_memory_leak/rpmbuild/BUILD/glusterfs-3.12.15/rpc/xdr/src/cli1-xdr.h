...
enum gf_cli_defrag_type {
	...
	GF_DEFRAG_CMD_START = 0 + 1,
	GF_DEFRAG_CMD_STOP = 0 + 2,
	GF_DEFRAG_CMD_STATUS = 0 + 3,
	GF_DEFRAG_CMD_START_LAYOUT_FIX = 0 + 4,
	GF_DEFRAG_CMD_START_FORCE = 0 + 5,
	GF_DEFRAG_CMD_START_TIER = 0 + 6,
	GF_DEFRAG_CMD_STATUS_TIER = 0 + 7,
	GF_DEFRAG_CMD_START_DETACH_TIER = 0 + 8,
	GF_DEFRAG_CMD_STOP_DETACH_TIER = 0 + 9,
	GF_DEFRAG_CMD_PAUSE_TIER = 0 + 10,
	GF_DEFRAG_CMD_RESUME_TIER = 0 + 11,
	GF_DEFRAG_CMD_DETACH_STATUS = 0 + 12,
	GF_DEFRAG_CMD_STOP_TIER = 0 + 13,
	GF_DEFRAG_CMD_DETACH_START = 0 + 14,
	GF_DEFRAG_CMD_DETACH_COMMIT = 0 + 15,
	GF_DEFRAG_CMD_DETACH_COMMIT_FORCE = 0 + 16,
	GF_DEFRAG_CMD_DETACH_STOP = 0 + 17,
	GF_DEFRAG_CMD_TYPE_MAX = 0 + 18,
};
...
enum gf_bitrot_type {
	...
	GF_BITROT_CMD_SCRUB_ONDEMAND = 0 + 8,
	GF_BITROT_OPTION_TYPE_MAX = 0 + 9,
};
...
typedef enum gf_cli_get_state_op gf_cli_get_state_op;
...
extern  bool_t xdr_gf_cli_get_state_op (XDR *, gf_cli_get_state_op*);
...
extern bool_t xdr_gf_cli_get_state_op ();
